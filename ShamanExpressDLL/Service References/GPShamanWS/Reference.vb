...
Namespace GPShamanWS
    ...
    Public Interface ServiceSoap
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/setPushNotification", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function setPushNotification(ByVal license As String, ByVal mobile As String, ByVal message As String) As Boolean
    End Interface
    ...
    Partial Public Class ServiceSoapClient
        ...
        Public Function setPushNotification(ByVal license As String, ByVal mobile As String, ByVal message As String) As Boolean Implements GPShamanWS.ServiceSoap.setPushNotification
            Return MyBase.Channel.setPushNotification(license, mobile, message)
        End Function
    End Class
End Namespace
