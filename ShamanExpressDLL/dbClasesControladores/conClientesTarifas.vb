...
Public Class conClientesTarifas
    ...
    Public Function GetTarifaPrincipal(ByVal pCli As Int64) As Int64
        ...
        End Try
    End Function
    Public Function SetTarifaPrincipal(ByVal pCli As Int64, ByVal pTar As Int64, Optional ByVal pExcApl As Integer = 0) As Boolean
        ...
        Try
            ...
            If pTar > 0 Then
                ...
                objTarifaPrincipal.aplExcedente = pExcApl
