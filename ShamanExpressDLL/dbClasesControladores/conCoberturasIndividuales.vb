...
Public Class conCoberturasIndividuales
    Inherits typCoberturasIndividuales
    ...
    Public Function GetAll() As DataTable
        ...
        Try
            ...
            SQL = SQL & "FROM CoberturasIndividuales "
    ...
    Public Function GetIDByAbreviaturaId(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM CoberturasIndividuales WHERE (AbreviaturaId = '" & pVal & "')"
    ...
    Public Function GetIDByDescripcion(ByVal pVal As String) As Int64
        ...
        Try
            Dim SQL As String
            SQL = "SELECT ID FROM CoberturasIndividuales WHERE (Descripcion = '" & pVal & "')"
    ...
    Public Function Validar(Optional ByVal pMsg As Boolean = True) As Boolean
        ...
        Try
            Dim vRdo As String = ""
            Validar = True
            If Me.AbreviaturaId = "" Then vRdo = "Debe determinar el código de la cobertura individual"
            If Me.Descripcion = "" And vRdo = "" Then vRdo = "Debe determinar el nombre de la cobertura individual"
            If vRdo <> "" Then
                Validar = False
